...
public class GetPropertyByUuidApiMethodTest
{
    private readonly ITestOutputHelper _outputHelper;
    private readonly ApiMethodInvoker _invoker;
    private readonly GetPropertyByUuidApiMethod _apiMethod;
    private readonly Mock<IGetPropertyByUuidUseCase> _useCaseMock;

    public GetPropertyByUuidApiMethodTest(ITestOutputHelper outputHelper, ApiMethodInvokerHolder apiMethodInvokerHolder)
    {
        _outputHelper = outputHelper;
        _invoker = apiMethodInvokerHolder.GetApiMethodInvoker();
        _useCaseMock = new Mock<IGetPropertyByUuidUseCase>(MockBehavior.Strict);
        IGetPropertyByUuidController controller = new GetPropertyByUuidController(_useCaseMock.Object);
        _apiMethod = new GetPropertyByUuidApiMethod(controller);
    }

    [UseCulture("en-US")]
    [Trait("Category", "WebApi Collection [NoContext]")]
    [Fact(DisplayName = "GET /api/properties/{uuid} should return 500 Internal Server Error when use case throws an exception")]
    public async Task FailedToGetByIdReturningInternalServerError()
    {
        // Arrange
        _useCaseMock.Setup(useCase => useCase.ExecuteAsync(new GetPropertyByUuidQuery("77c1c391-b488-488e-b312-652fa086b693")))
            .ThrowsAsync(new Exception("Unexpected error"));

        // Act
        ObjectResult objectResult = await _invoker.InvokeAsync(() => _apiMethod.GetPropertyByUuid("77c1c391-b488-488e-b312-652fa086b693"));
    ...
    public async Task FailedToGetByIdReturningInternalServerErrorInPtBr()
    {
        ...
        // Act
        ObjectResult objectResult = await _invoker.InvokeAsync(() => _apiMethod.GetPropertyByUuid("77c1c391-b488-488e-b312-652fa086b693"), "pt-BR");
    ...
    [UseCulture("en-US")]
    [Trait("Category", "WebApi Collection [NoContext]")]
    [Fact(DisplayName = "GET /api/properties/{uuid} should return 200 OK")]
    public async Task SuccessfulToGetByUuidReturningProperty()
    {
        // Arrange
        _useCaseMock.Setup(useCase => useCase.ExecuteAsync(new GetPropertyByUuidQuery("77c1c391-b488-488e-b312-652fa086b693")))
            .ReturnsAsync(
        ...
        // Act
        ObjectResult objectResult = await _invoker.InvokeAsync(() => _apiMethod.GetPropertyByUuid("77c1c391-b488-488e-b312-652fa086b693"), "en-US");
        ...
        JsonAssertHelper.AssertThat(jsonElement)
            ...
            .AndExpectThat(JsonFrom.Path("$.uuid"), Is<string>.EqualTo("77c1c391-b488-488e-b312-652fa086b694"))
